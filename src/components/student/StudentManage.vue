<template>
  <div>
    <div style="margin-bottom: 20px;margin-top: 5px">
      <el-input  v-model="sname" placeholder="请输入学号" suffix-icon="el-icon-search" style="width: 200px;"
    ...
    <el-table
      ...
      <el-table-column prop="sname" label="姓名" width="160">
      </el-table-column>
      <el-table-column prop="sage" label="年龄" width="200">
      </el-table-column>
      <el-table-column prop="sc" label="班级" width="200">
      </el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        sage: [
          {required: true, message: '请输入年龄数', trigger: 'blur'},
        ...
        sc: [
          {required: true, message: '请输入学生所在班级', trigger: 'blur'}
        ]
  ...
  methods:{
    ...
    del(sno){
      ...
      this.$axios.get(this.$httpUrl+'/student/del?sno='+sno).then(res=>res.data).then(res=>{
